...
javac9 --release 8 -d target/mr/java-8 target/mr/java-8-src/*.java
...
javac9 --release 8 -d target/mr/java-9 target/mr/java-9-src/*.java

echo "package"
jar9 --create --file target/mr/mr.jar -C target/mr/java-8 . --release 9 -C target/mr/java-9 .

echo "run with Java 8:"
java -cp target/mr/mr.jar org.codefx.demo.java9.internal.multi_release.Main

echo "run with Java 9:"
java9 -cp target/mr/mr.jar org.codefx.demo.java9.internal.multi_release.Main
