...
* [`Stream` improvements](src/org/codefx/demo/java9/api/stream) ([post on CodeFX](http://blog.codefx.org/java/dev/java-9-stream/))
* [`Optional` improvements](src/org/codefx/demo/java9/api/optional) ([post on CodeFX](http://blog.codefx.org/java/dev/java-9-optional/))
